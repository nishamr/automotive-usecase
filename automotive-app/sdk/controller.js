...
return{
	...
	registerProduct: function(req, res){
		...
		var ProductUUID = input.ProductUUID;
		var ProductExternalID = input.ProductExternalID;
		var PartName = input.PartName;
		var PartNum = input.PartNum;
		var ForModels = input.ForModels;
		var ManufacturedBy = input.ManufacturedBy;
		var ManufacturedAt = input.ManufacturedAt;
		var ManufacturedDate = input.ManufacturedDate;
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        //targets : --- letting this default to the peers assigned to the channel
		        chaincodeId: 'amchaincode',
		        fcn: 'registerProduct',
		        args: [ProductUUID, ProductExternalID, PartName, PartNum, ForModels, ManufacturedBy, ManufacturedAt, ManufacturedDate],
		        //chainId: 'mychannel',
				txId: tx_id
		    };
			console.log(request)
	...
	transferProduct: function(req, res){
		console.log(req.body);
		console.log("Updating charging details: ");
		...
		var HashProductExternalID = input.HashProductExternalID;
		var Receiver = input.Receiver;
		var ReceiverType = input.ReceiverType;
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'amchaincode',
		        fcn: 'transferProduct',
		        args: [HashProductExternalID, Receiver, ReceiverType, Location, Timestamp],
		        //chainId: 'mychannel',
				txId: tx_id
		    };
			console.log(request)
